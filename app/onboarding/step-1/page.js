          ...
          >
            ...
            <div className="mb-8 pr-12">
              ...
              <p className="mt-2 text-sm leading-6 text-gray-500">
                Enter your email and set a secure password. This helps us keep
                your account safe and ready for future logins.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-4 pt-2">
                ...
                <p className="text-center text-xs leading-5 text-gray-400">
                  ...
                  <Link href="/terms" className="font-medium text-gray-600">
                    Terms of Use
                  </Link>{" "}
                  and{" "}
                  <Link href="/privacy" className="font-medium text-gray-600">
                    Privacy Policy
                  </Link>
                  .
                </p>
